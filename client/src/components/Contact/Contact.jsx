  ...
  return (
    ...
    >
      ...
      <div className="relative z-10">
        ...
        {/* Bottom CTA */}
        <div className="mt-24">
          <div className="overflow-hidden rounded-[32px] border border-slate-200 bg-gradient-to-r from-blue-600 via-sky-500 to-cyan-500 p-[1px] shadow-2xl">
            <div className="rounded-[31px] bg-white px-8 py-10 lg:px-12">
